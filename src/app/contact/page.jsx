    ...
    <section className="min-h-screen py-12 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-center md:items-start gap-40 h-full font-andale mt-8">
        <div className="flex-1 flex justify-center items-center relative">
          <img
            src="/images/Generative Fill.jpg"
            alt=""
          ...
          <img
            ...
            alt=""
            className="absolute size-48 md:size-80 md:-right-40 md:-bottom-10 -bottom-32"
          />
        </div>
        <div className="flex-1 flex flex-col justify-center items-start gap-10">
          ...
          <a href={"https://www.instagram.com/tatvamjaipur/"} target="_">
            <p>@tatvamjaipur</p>
          </a>
        </div>
      </div>
