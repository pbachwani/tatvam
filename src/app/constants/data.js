const projects = [
  ...
  },
  {
      ...
      extras: [
        {
          image: "/images/tatvam-vas/1.jpg",
          heading: "Project image 1",
          text: "Even the smallest details uphold this balance. Entrances open with generous double doors, echoing welcome. Washbasins once cast in village homes reappear in sculpted marble, now freestanding and sculptural. Fixtures are modernized, yet their essence remains rooted.",
        },
        {
          image: "/images/tatvam-vas/2.jpg",
          heading: "Project image 2",
          text: "It is in this tension - between memory and magnificence, between the village and the palace - that Ekatva finds its voice. A home that resonates with its context without dissolving into it; one that honours the ordinary, yet renders it extraordinary.",
        },
        // Add more as needed
      ],
    },
    description: {
      intro:
        "Ekatva - Oneness, unity of many lives into one soul - speaks of becoming whole - of many voices, many journeys, many generations converging into harmony. This residence embodies that spirit, where village roots, disciplined paths, and global horizons meet under one roof. More than a home, it is a single soul that holds them all.",
      description: `More than a residence; it is a story of four generations woven into one home. For the elders, it stands as a tribute to village life - slow, grounded, and deeply spiritual. For the middle generation, shaped by a military background and journeys across India, it reflects discipline, openness, and the dignity of leadership. For the youngest, reaching toward global horizons, it remains a reminder of roots they never wish to lose. As the home of the head of Antrolli, Ekatva rises as both emblem and dwelling. Its five-foot plinth and soaring entrance carry the gravity of a temple, a presence that commands respect in the village while welcoming intimacy within. The house becomes a landmark - rare in its scale, yet deeply true to its soil. The interiors continue this dialogue of extremes. Lime washes soften the walls, arches curve with quiet regality, and bathrooms abandon tiles for stone and marble patterns. Every material is drawn from the earth - Kota stone, lime, terrazzo, brass - yet each is reimagined with refinement. Kota stone, familiar in its village form, is given a regal expression; niches return, not rustic but elevated; arches frame bedrooms with grandeur; and brass inlays weave intricacy into the everyday.`,
      extra:
